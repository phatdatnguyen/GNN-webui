...
def train(dataloader, gcn_model_name):
    ...
    for batch in dataloader:
        ...
        if gcn_model_name in ["GCN", "GraphSAGE", "SGConv", "ClusterGCN", "GraphConv", "ChebConv", "LEConv", "EGConv", "MFConv", "TAGConv", "ARMAConv", "FiLMConv"]:
            ...
            with gr.Row(equal_height=True):
                with gr.Column(scale=1):
                    with gr.Group():
                        ...
                        gcn_model_name = gr.Dropdown(label="Graph convolutional layer", value="GCN", choices=["GCN", "GraphSAGE", "SGConv", "ClusterGCN", "GraphConv", "ChebConv", "LEConv", "EGConv", "MFConv", "TAGConv", "ARMAConv", "FiLMConv", "PDNConv", "GENConv", "ResGatedGraphConv", "GAT", "GATv2", "SuperGAT", "TransformerConv", "GeneralConv"])
